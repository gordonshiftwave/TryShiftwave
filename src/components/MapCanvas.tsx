...
export function MapCanvas({
  ...
  return (
    <div className="map-shell paper-card relative h-full min-h-[280px] overflow-hidden p-1.5">
      <div ref={containerRef} className="h-full min-h-[268px] overflow-hidden rounded-[22px]" />
    </div>
  )
}
