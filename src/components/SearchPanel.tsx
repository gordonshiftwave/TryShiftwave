      ...
      >
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 sm:flex-none h-12 sm:h-14 min-w-[7.5rem] px-5 rounded-[18px] bg-rise text-cream font-semibold whitespace-nowrap disabled:opacity-50 hover:brightness-[1.04] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus"
          >
          ...
          <button
            ...
            disabled={busy}
            className="flex-1 sm:flex-none h-12 sm:h-14 min-w-[10.5rem] px-4 rounded-[18px] border border-line bg-cream text-ink font-semibold whitespace-nowrap hover:bg-sand disabled:opacity-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus"
          >
